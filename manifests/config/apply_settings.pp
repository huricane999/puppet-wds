...
class wds::config::apply_settings {
  #Authorize
  if $::wds::config::authorize and $::wd_conf['server_authorization']['authorization_state'] == 'Not Authorized' {
    exec { 'WDS Server - Authorize':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /Authorize:Yes',
    }
  } elsif !$::wds::config::authorize and $::wd_conf['server_authorization']['authorization_state'] != 'Not Authorized' {
  ...
  #Rogue Detection
  if $::wds::config::rogue_detection and $::wd_conf['pxe_bind_policy']['rogue_detection'] == 'Not Authorized' {
    exec { 'WDS Server - Enable Rogue Detection':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /RogueDetection:Yes',
    }
  } elsif !$::wds::config::rogue_detection and $::wd_conf['pxe_bind_policy']['rogue_detection'] != 'Not Authorized' {
  ...
  case $::wds::config::answer_clients {
    'Known': {
      if $::wd_conf['answer_policy']['answer_clients'] == 'No' or $::wd_conf['answer_policy']['answer_only_known_clients'] == 'No' {
    ...
    'None': {
      if $::wd_conf['answer_policy']['answer_clients'] == 'Yes' or $::wd_conf['answer_policy']['answer_only_known_clients'] == 'Yes' {
    ...
    default: {
      if $::wd_conf['answer_policy']['answer_clients'] == 'No' or $::wd_conf['answer_policy']['answer_only_known_clients'] == 'Yes' {
  ...
  #Response Delay
  if $::wds::config::response_delay != $::wd_conf['answer_policy']['response_delay'] {
  ...
  if $::wd_conf['boot_program_policy']['allow_n12_for_new_clients'] != '<Not Applicable>' {
    if $::wds::config::allow_n12_for_new_clients and $::wd_conf['boot_program_policy']['allow_n12_for_new_clients'] == 'No' {
      exec { 'WDS Server - Allow N12 for New Clients':
        command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /AllowN12ForNewClients:Yes',
      }
    } elsif !$::wds::config::allow_n12_for_new_clients and $::wd_conf['boot_program_policy']['allow_n12_for_new_clients'] == 'Yes' {
  ...
  #Reset Boot Program
  if $::wds::config::reset_boot_program and $::wd_conf['boot_program_policy']['reset_boot_program'] == 'No' {
    exec { 'WDS Server - Reset Boot Program':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /ResetBootProgram:Yes',
    }
  } elsif !$::wds::config::reset_boot_program and $::wd_conf['boot_program_policy']['reset_boot_program'] == 'Yes' {
  ...
  if $::wds::config::default_x86_x64_image_type != $::wd_conf['boot_image_policy']['default_x86_x64_image_type'] {
  ...
  #Use DHCP Ports
  if $::wds::config::use_dhcp_ports and $::wd_conf['pxe_bind_policy']['use_dhcp_ports'] == 'No' {
    exec { 'WDS Server - Use DHCP Ports':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /UseDhcpPorts:Yes',
    }
  } elsif !$::wds::config::use_dhcp_ports and $::wd_conf['pxe_bind_policy']['use_dhcp_ports'] == 'Yes' {
  ...
  #Set DHCP Option 60
  if $::wd_conf['dhcp_configuration']['dhcp_service_status'] == 'Installed' {
    if $::wds::config::dhcp_option_60 and $::wd_conf['dhcp_configuration']['dhcp_option_60_configured'] == 'No' {
      exec { 'WDS Server - Set DHCP Option 60':
        command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /DhcpOption60:Yes',
      }
    } elsif !$::wds::config::dhcp_option_60 and $::wd_conf['dhcp_configuration']['dhcp_option_60_configured'] == 'Yes' {
  ...
  #RPC Port
  if $::wds::config::rpc_port != $::wd_conf['pxe_bind_policy']['rpc_port'] {
  ...
  if $::wds::config::pxe_prompt_policy_known != $::wd_conf['boot_program_policy']['known_client_pxe_prompt_policy'] {
  ...
  if $::wds::config::pxe_prompt_policy_new != $::wd_conf['boot_program_policy']['new_client_pxe_prompt_policy'] {
  ...
  #Boot Program - x86
  if $::wds::config::boot_program_x86 != $::wd_conf['boot_program_policy']['default_boot_programs']['x86'] {
  ...
  #Boot Program - x64
  if $::wds::config::boot_program_x64 != $::wd_conf['boot_program_policy']['default_boot_programs']['x64'] {
  ...
  #Boot Program - ia64
  if $::wds::config::boot_program_ia64 != $::wd_conf['boot_program_policy']['default_boot_programs']['ia64'] {
  ...
  if $::wds::config::n12_boot_program_x86 != $::wd_conf['boot_program_policy']['default_n12_boot_programs']['x86'] {
  ...
  if $::wds::config::n12_boot_program_x64 != $::wd_conf['boot_program_policy']['default_n12_boot_programs']['x64'] {
  ...
  if $::wds::config::n12_boot_program_ia64 != $::wd_conf['boot_program_policy']['default_n12_boot_programs']['ia64'] {
  ...
  #Boot Image - x86
  if $::wds::config::boot_image_x86 != $::wd_conf['boot_image_policy']['default_boot_images']['x86'] {
  ...
  #Boot Image - x64
  if $::wds::config::boot_image_x64 != $::wd_conf['boot_image_policy']['default_boot_images']['x64'] {
  ...
  #Boot Image - ia64
  if $::wds::config::boot_image_ia64 != $::wd_conf['boot_image_policy']['default_boot_images']['ia64'] {
  ...
  #Preferred DC
  if $::wds::config::preferred_dc != $::wd_conf['active_directory_use_policy']['preferred_dc'] {
  ...
  #Preferred GC
  if $::wds::config::preferred_gc != $::wd_conf['active_directory_use_policy']['preferred_gc'] {
  ...
  #Prestage Using MAC
  if $::wds::config::prestage_using_mac and $::wd_conf['active_directory_use_policy']['prestage_devices_using_mac'] == 'No' {
    exec { 'WDS Server - Prestage Using MAC':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /PrestageUsingMAC:Yes',
    }
  } elsif !$::wds::config::prestage_using_mac and $::wd_conf['active_directory_use_policy']['prestage_devices_using_mac'] == 'Yes' {
  ...
  if $::wds::config::new_machine_naming_policy != $::wd_conf['active_directory_use_policy']['new_computer_naming_policy'] {
  ...
  #New Machine Type
  if $::wds::config::new_machine_type != $::wd_conf['new_computer_ou']['ou_type'] {
  ...
  #New Machine OU
  if $::wds::config::new_machine_ou != $::wd_conf['new_computer_ou']['ou'] {
  ...
  case $::wds::config::domain_search_order {
    'DCFirst': {
      if $::wd_conf['active_directory_use_policy']['domain_search_order'] != 'Domain Controller First' {
    ...
    default: {
      if $::wd_conf['active_directory_use_policy']['domain_search_order'] != 'Global Catalog Only' {
        exec { 'WDS Server - Domain Search Order':
  ...
  if $::wds::config::new_machine_domain_join and $::wd_conf['active_directory_use_policy']['new_computers_join_domain'] == 'No' {
    exec { 'WDS Server - New Machine Domain Join':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /NewMachineDomainJoin:Yes',
    }
  } elsif !$::wds::config::new_machine_domain_join and $::wd_conf['active_directory_use_policy']['new_computers_join_domain'] == 'Yes' {
  ...
  #WDS Client Logging
  if $::wds::config::wds_client_logging and $::wd_conf['wds_client_policy']['logging_policy']['enabled'] == 'No' {
    exec { 'WDS Server - WDS Client Logging Enabled':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /WdsClientLogging /Enabled:Yes',
    }
  } elsif !$::wds::config::wds_client_logging and $::wd_conf['wds_client_policy']['logging_policy']['enabled'] == 'Yes' {
  ...
  if $::wds::config::wds_client_logging_level != $::wd_conf['wds_client_policy']['logging_policy']['loging_level'] {
  ...
  #WDS Unattend Policy
  if $::wds::config::wds_unattend_policy and $::wd_conf['wds_client_policy']['unattend_policy']['enabled'] == 'No' {
    exec { 'WDS Server - WDS Unattend Policy Enabled':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /WdsUnattend /Policy:Enabled',
    }
  } elsif !$::wds::config::wds_unattend_policy and $::wd_conf['wds_client_policy']['unattend_policy']['enabled'] == 'Yes' {
  ...
  if $::wds::config::wds_unattend_commandline_precedence and $::wd_conf['wds_client_policy']['unattend_policy']['command-line_precedence'] == 'No' {
  ...
  } elsif !$::wds::config::wds_unattend_commandline_precedence and $::wd_conf['wds_client_policy']['unattend_policy']['command-line_precedence'] == 'Yes' {
  ...
  if is_hash($::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files']) and has_key($::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files'], 'x86') {
    if $::wds::config::wds_unattend_file_x86 != $::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files']['x86'] {
  ...
  if is_hash($::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files']) and has_key($::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files'], 'x64') {
  if $::wds::config::wds_unattend_file_x64 != $::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files']['x64'] {
  ...
  if is_hash($::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files']) and has_key($::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files'], 'ia64') {
  if $::wds::config::wds_unattend_file_ia64 != $::wd_conf['wds_client_policy']['unattend_policy']['wds_unattend_files']['ia64'] {
  ...
  #Auto Add Policy
  if $::wds::config::auto_add_policy != $::wd_conf['pending_device_policy']['policy'] {
  ...
  if $::wds::config::auto_add_policy_poll_interval != $::wd_conf['pending_device_policy']['poll_interval'] {
  ...
  if $::wds::config::auto_add_policy_max_retry_count != $::wd_conf['pending_device_policy']['max_retry_count'] {
  ...
  if $::wds::config::auto_add_policy_message != $::wd_conf['pending_device_policy']['message_to_pending_clients'] {
  ...
  if $::wds::config::auto_add_policy_retention_period_approved != $::wd_conf['pending_device_policy']['retention_period']['approved_devices'] {
  ...
  if $::wds::config::auto_add_policy_retention_period_others != $::wd_conf['pending_device_policy']['retention_period']['other_devices'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['boot_program'] != $::wd_conf['pending_device_policy']['defaults_for_x86']['boot_program_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['boot_image'] != $::wd_conf['pending_device_policy']['defaults_for_x86']['boot_image_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['referral_server'] != $::wd_conf['pending_device_policy']['defaults_for_x86']['referral_server'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['wds_client_unattend'] != $::wd_conf['pending_device_policy']['defaults_for_x86']['wds_client_unattend_file_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['user'] != $::wd_conf['pending_device_policy']['defaults_for_x86']['user'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['join_rights'] != $::wd_conf['pending_device_policy']['defaults_for_x86']['join_rights'] {
  ...
  if $::wds::config::auto_add_settings_combined_x86['join_domain'] and $::wd_conf['pending_device_policy']['defaults_for_x86']['join_domain'] == 'No' {
  ...
  } elsif !$::wds::config::auto_add_settings_combined_x86['join_domain'] and $::wd_conf['pending_device_policy']['defaults_for_x86']['join_domain'] == 'Yes' {
  ...
  if $::wds::config::auto_add_settings_combined_x64['boot_program'] != $::wd_conf['pending_device_policy']['defaults_for_x64']['boot_program_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_x64['boot_image'] != $::wd_conf['pending_device_policy']['defaults_for_x64']['boot_image_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_x64['referral_server'] != $::wd_conf['pending_device_policy']['defaults_for_x64']['referral_server'] {
  ...
  if $::wds::config::auto_add_settings_combined_x64['wds_client_unattend'] != $::wd_conf['pending_device_policy']['defaults_for_x64']['wds_client_unattend_file_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_x64['user'] != $::wd_conf['pending_device_policy']['defaults_for_x64']['user'] {
  ...
  if $::wds::config::auto_add_settings_combined_x64['join_rights'] != $::wd_conf['pending_device_policy']['defaults_for_x64']['join_rights'] {
  ...
  if $::wds::config::auto_add_settings_combined_x64['join_domain'] and $::wd_conf['pending_device_policy']['defaults_for_x64']['join_domain'] == 'No' {
  ...
  } elsif !$::wds::config::auto_add_settings_combined_x64['join_domain'] and $::wd_conf['pending_device_policy']['defaults_for_x64']['join_domain'] == 'Yes' {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['boot_program'] != $::wd_conf['pending_device_policy']['defaults_for_ia64']['boot_program_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['boot_image'] != $::wd_conf['pending_device_policy']['defaults_for_ia64']['boot_image_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['referral_server'] != $::wd_conf['pending_device_policy']['defaults_for_ia64']['referral_server'] {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['wds_client_unattend'] != $::wd_conf['pending_device_policy']['defaults_for_ia64']['wds_client_unattend_file_path'] {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['user'] != $::wd_conf['pending_device_policy']['defaults_for_ia64']['user'] {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['join_rights'] != $::wd_conf['pending_device_policy']['defaults_for_ia64']['join_rights'] {
  ...
  if $::wds::config::auto_add_settings_combined_ia64['join_domain'] and $::wd_conf['pending_device_policy']['defaults_for_ia64']['join_domain'] == 'No' {
  ...
  } elsif !$::wds::config::auto_add_settings_combined_ia64['join_domain'] and $::wd_conf['pending_device_policy']['defaults_for_ia64']['join_domain'] == 'Yes' {
  ...
  #Bind Policy
  if $::wds::config::bind_policy == 'Include' and $::wd_conf['interface_bind_policy']['policy'] == 'Exclude Registered' {
  ...
  } elsif $::wds::config::bind_policy == 'Exclude' and $::wd_conf['interface_bind_policy']['policy'] == 'Include Registered' {
  ...
  #Refresh Period
  if $::wds::config::refresh_period != $::wd_conf['server_automatic_refresh_policy']['refresh_period'] {
  ...
  #BCD Refresh Policy
  if $::wds::config::bcd_refresh_policy_period == 0 and $::wds::config::bcd_refresh_policy_period != $::wd_conf['bcd_refresh_policy']['enabled'] == 'Yes' {
    exec { 'WDS Server - BCD Refresh Policy Disabled':
      command => 'C:\\Windows\\System32\\wdsutil.exe /Set-Server /BcdRefreshPolicy /Enabled:No',
    }
  } elsif $::wds::config::bcd_refresh_policy_period > 0 and $::wds::config::bcd_refresh_policy_period != $::wd_conf['bcd_refresh_policy']['enabled'] == 'No' {
  ...
  if $::wds::config::bcd_refresh_policy_period > 0 and $::wds::config::bcd_refresh_policy_period != $::wd_conf['bcd_refresh_policy']['refresh_period'] {
  ...
  case $::wds::config::transport_obtain_ipv4_from {
    'Dhcp': {
      if !has_key($::wd_conf['wds_transport_server_policy'], 'ipv4_source_dhcp') {
    ...
    default: {
      if !has_key($::wd_conf['wds_transport_server_policy'], 'ipv4_source_range') or $::wds::config::transport_obtain_ipv4_from_start != $::wd_conf['wds_transport_server_policy']['ipv4_source_range']['start_address'] or $::wds::config::transport_obtain_ipv4_from_end != $::wd_conf['wds_transport_server_policy']['ipv4_source_range']['end_address'] {
  ...
  case $::wds::config::transport_obtain_ipv6_from {
    'Dhcp': {
      if !has_key($::wd_conf['wds_transport_server_policy'], 'ipv6_source_dhcp') {
    ...
    default: {
      if !has_key($::wd_conf['wds_transport_server_policy'], 'ipv6_source_range') or $::wds::config::transport_obtain_ipv6_from_start != $::wd_conf['wds_transport_server_policy']['ipv6_source_range']['start_address'] or $::wds::config::transport_obtain_ipv6_from_end != $::wd_conf['wds_transport_server_policy']['ipv6_source_range']['end_address'] {
  ...
  if !has_key($::wd_conf['wds_transport_server_policy'], 'udp_port_policy_dynamic') {
    if $::wds::config::transport_start_port != $::wd_conf['wds_transport_server_policy']['udp_port_policy_dynamic']['start_port'] or $::wds::config::transport_end_port != $::wd_conf['wds_transport_server_policy']['udp_port_policy_dynamic']['end_port'] {
  ...
  #Transport Profile
  if $::wd_conf['wds_transport_server_policy']['network_profile'] != '<Not Applicable>' {
    if $::wds::config::transport_profile != $::wd_conf['wds_transport_server_policy']['network_profile'] {
  ...
  case $::wds::config::transport_multicast_session_policy {
    'AutoDisconnect': {
      if $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['slow_client_handling_policy'] != 'AutoDisconnect' or $::wds::config::transport_multicast_session_policy_threshold != $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['autodisconnect_threshold'] {
    ...
    'Multistream': {
      if $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['slow_client_handling_policy'] != 'Multistream' or $::wds::config::transport_multicast_session_policy_stream_count != $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['multistream_stream_count'] {
        if $::wds::config::transport_multicast_session_policy_fallback and $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['slow_client_fallback'] == 'No' {
          exec { 'WDS Server - Transport Multicast Session Policy - Multistream':
            command => "C:\\Windows\\System32\\wdsutil.exe /Set-Server /Transport /MulticastSessionPolicy /Policy:AutoDisconnect /Threshold:${::wds::config::transport_multicast_session_policy_threshold}",
          }
        } elsif !$::wds::config::transport_multicast_session_policy_fallback and $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['slow_client_fallback'] == 'Yes' {
          exec { 'WDS Server - Transport Multicast Session Policy - Multistream':
            command => "C:\\Windows\\System32\\wdsutil.exe /Set-Server /Transport /MulticastSessionPolicy /Policy:AutoDisconnect /Threshold:${::wds::config::transport_multicast_session_policy_threshold}",
          }
        }
    ...
    default: {
      if $::wd_conf['wds_transport_server_policy']['multicast_session_policy']['slow_client_handling_policy'] != 'None' {
  ...
  if $::wds::config::transport_force_native and $::wd_conf['server_state']['wds_operational_mode'] != 'Native' {
